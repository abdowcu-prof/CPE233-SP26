...
// This program introduce easy ways to add advanced 
// debugging methods to trace problems with recursive algorithms
...
int FindMatch(vector<string> stringsList, string itemMatch,
              int lowVal, int highVal) { // indentAmt used for print debug
   ...
   static string message = "...";
        ...
        cout << message << "CALL: " <<counter << " - Find() range " << lowVal << " " << highVal << endl;
        counter++;
